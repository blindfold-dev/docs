...
<CardGroup cols={2}>
  ...
  <Card title="Policy Management" icon="cog" href="#policy-management-endpoints">
    Create and manage detection policies
  </Card>
...
<Info>
  Policies allow you to define reusable configurations that combine entity types and detection thresholds. Use global policies for compliance (GDPR, HIPAA, PCI DSS) or create custom policies for your specific needs.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Custom Policies" icon="gear">
