...
<CardGroup cols={2}>
  ...
  <Card title="Local Mode" icon="server">
    80+ entity types with no API key — no data ever leaves your infrastructure
  </Card>
</CardGroup>
...
Install the SDK and start detecting PII immediately — no signup needed for local mode.
