...
<CardGroup cols={2}>
  ...
  <Card title="LangChain" icon="python" href="https://github.com/blindfold-dev/blindfold-cookbook/tree/main/examples/langchain-python">
    PII-safe chains with RunnableLambda
  </Card>
  <Card title="GDPR + OpenAI" icon="shield-check" href="https://github.com/blindfold-dev/blindfold-cookbook/tree/main/examples/gdpr-openai-python">
    EU region, gdpr_eu policy, batch processing
  </Card>
  <Card title="HIPAA Healthcare Chatbot" icon="hospital" href="https://github.com/blindfold-dev/blindfold-cookbook/tree/main/examples/hipaa-healthcare-chatbot">
    Multi-turn chat with hipaa_us policy, PHI redaction
  </Card>
  <Card title="E2B Data Analyst" icon="robot" href="https://github.com/blindfold-dev/blindfold-cookbook/tree/main/examples/e2b-data-analyst">
