...
Output: [{entity_type: "Person", text: "John Doe", start: 8, end: 16, score: 0.99},
         {entity_type: "Email Address", text: "john@example.com", start: 20, end: 36, score: 0.98}]
```
...
found_types = {e.entity_type for e in result.detected_entities}
...
# result.detected_entities → [{entity_type: "Social Security Number", ...}]
  ...
  <Tab title="cURL">
    ...
    # Response
    {
      ...
      "detected_entities": [
        ...
        {
          "entity_type": "Social Security Number",
          "text": "123-45-6789",
          "start": 42,
          "end": 53,
          "score": 0.97
...
def safe_ai_call(user_message: str) -> str:
    ...
    found = {e.entity_type for e in scan.detected_entities}
